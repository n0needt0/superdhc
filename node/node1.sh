...
sed -i 's/THISNODEID/node1/g' /etc/dhc4/cleaner.cfg
...
sed -i 's/THISNODEID/node1/g' /etc/dhc4/dispatch.cfg
...
sed -i 's/THISNODEID/node1/g' /etc/dhc4/node.cfg
...
sed -i 's/THISNODEID/node1/g' /etc/ganglia/gmond.conf
