...
sed -i 's/THISNODEID/home2/g' /etc/fortihealth/home-node.cfg
sed -i 's/MYIPADDRESS/192.168.82.110/g' /etc/fortihealth/home-node.cfg
...
sed -i 's/THISNODEID/home2/g' /etc/fortihealth/home-cleaner.cfg
sed -i 's/MYIPADDRESS/192.168.82.110/g' /etc/fortihealth/home-cleaner.cfg
...
sed -i 's/THISNODEID/home2/g' /etc/ganglia/gmond.conf
